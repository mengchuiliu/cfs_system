...
import listener.OnPagerSlidingListener;
import listener.OnTabSelectListener;

/**
 * 标题TabLayout和ViewPager的组合
 */
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    //刷新标题
    public void refreshTitle(ArrayList<String> titles, int curTab) {
        if (titles != null && !titles.isEmpty()) {
            this.mCurrentTab = curTab;
            mTabsContainer.removeAllViews();
            ...
            Toast.makeText(mContext, "标题为空!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public ArrayList<String> getTitles() {
        return mTitles == null ? new ArrayList<String>() : mTitles;
    }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void onPageSelected(int position) {
        ...
        if (slidingListener != null) {
            slidingListener.onPagerSliding(position);
        }
    }
    ...
    private OnPagerSlidingListener slidingListener;

    public void setOnPagerSlidingListener(OnPagerSlidingListener slidingListener) {
